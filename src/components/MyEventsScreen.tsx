    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-primary to-[#3B6EA5] text-white px-6 py-6 sticky top-0 z-10">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="mb-1">Мои мероприятия</h1>
            <p className="text-[#A7D8F0]">{events.length} {events.length === 1 ? 'мероприятие' : 'мероприятий'}</p>
          </div>
          <Button
      ...
      <div className="px-6 py-6">
        {events.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="mb-2 text-foreground">Нет мероприятий</h3>
            <p className="text-muted-foreground mb-6">Создайте свое первое мероприятие</p>
            <Button
              onClick={onCreateEvent}
          ...
          <div className="space-y-8">
            ...
            {upcomingEvents.length > 0 && (
              <div>
                <h3 className="mb-4 text-foreground">Предстоящие</h3>
            ...
            {pastEvents.length > 0 && (
              <div>
                <h3 className="mb-4 text-foreground">Прошедшие</h3>
                <div className="space-y-3">
