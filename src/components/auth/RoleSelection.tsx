        ...
        <div className="w-full space-y-4 max-w-sm">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-card-foreground mb-1">Создатель мероприятий</h3>
                <p className="text-muted-foreground">Организуйте свои тои</p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-primary">
              <span>Вход через телефон</span>
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <h3 className="text-card-foreground mb-1">Владелец здания</h3>
                <p className="text-muted-foreground">Сдавайте площадки</p>
              </div>
            </div>
