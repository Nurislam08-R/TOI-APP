...
export function BudgetPieChart({ budgetItems }: BudgetPieChartProps) {
  const categories = [
    { id: 'venue', name: 'Площадка', color: '#1FB6B4' },
    { id: 'food', name: 'Еда', color: '#FF6B6B' },
    { id: 'decor', name: 'Декор', color: '#D4A017' },
    { id: 'music', name: 'Музыка', color: '#4ECDC4' },
    { id: 'photo', name: 'Фото/Видео', color: '#3B6EA5' },
        ...
        {segments.map((segment, index) => (
          ...
          >
            ...
            <div className="text-right">
              <p className="text-foreground">{segment.amount.toLocaleString()} сом</p>
