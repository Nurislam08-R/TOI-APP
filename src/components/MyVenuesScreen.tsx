  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="bg-gradient-to-br from-primary to-[#2A5A8A] pt-8 pb-6 px-6 rounded-b-3xl mb-6">
        ...
        <h1 className="text-white mb-3">Мои заведения</h1>
        ...
        <p className="text-white/80">
          {venues.length} {venues.length === 1 ? 'заведение' : 'заведений'}
        </p>
      </div>
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="flex items-center gap-2 text-muted-foreground">
                      ...
                      <span>до {venue.capacity} чел</span>
                    </div>
                    <div className="flex items-center gap-2 text-accent">
                      <span>{venue.price.toLocaleString()} сом</span>
                    </div>
                  </div>
